...
const SETTINGS_ENTRIES: SettingsEntry[] = [
  ...
  { label: "Printing", section: "Store", description: "Print templates, receipts, labels", href: "/settings/store/printing" },
  ...
  { label: "QC Settings", section: "Tickets", description: "Quality control checklists", href: "/settings/tickets/qc" },
  ...
  { label: "Invoice Settings", section: "Invoice", description: "Invoice numbering, defaults", href: "/settings/invoice/general" },
  { label: "Invoice Templates", section: "Invoice", description: "Customize invoice layout", href: "/settings/invoice/templates" },
  { label: "Payment", section: "Invoice", description: "Payment methods and gateways", href: "/settings/invoice/payment" },
