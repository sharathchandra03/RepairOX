...
export default function AddStaffPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    router.push("/roles-permissions?created=1");
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Button variant="outline" size="md" className="gap-1.5 rounded-full" onClick={() => router.push("/roles-permissions")}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_320px]">
        <form onSubmit={onSubmit} className="space-y-6 rounded-2xl border border-border bg-card p-6 shadow-card sm:p-7">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label>Staff member has login credentials?</Label>
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <Button type="button" variant="outline" size="lg" className="rounded-full" onClick={() => router.push("/roles-permissions")}>
              Cancel
            </Button>
          </div>
        </form>
