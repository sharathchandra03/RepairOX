...
const DEFAULT_LAYOUTS: Record<string, LayoutItem[]> = {
  lg: [
    ...
    { i: "todays_focus",  x: 0, y: 10, w: 7, h: 5, minW: 4, minH: 3 },
    { i: "orders_status", x: 7, y: 10, w: 5, h: 5, minW: 3, minH: 3 },
  ],
  md: [
    { i: "revenue",       x: 0, y: 0, w: 8, h: 5, minW: 4, minH: 3 },
    { i: "donut",         x: 8, y: 0, w: 4, h: 5, minW: 3, minH: 3 },
  ...
  sm: [
    ...
    { i: "todays_focus",  x: 0, y: 20, w: 12, h: 5, minW: 12, minH: 3 },
    { i: "orders_status", x: 0, y: 25, w: 12, h: 5, minW: 12, minH: 3 },
  ],
};
