...
export function DemoBanner() {
  const { isDemoMode, resetDemo, adminRoleId, demoRoleIds } = usePermissions();

  // Debug: show current role info when demo is not activating as expected
  if (!isDemoMode && typeof window !== "undefined") {
    const debugInfo = `[Demo Debug] Role: ${adminRoleId} | Demo roles: ${JSON.stringify(demoRoleIds)}`;
    if (typeof console !== "undefined") console.log(debugInfo);
  }
